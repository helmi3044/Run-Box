...
void displayMe(void){
    ...
    glBegin(GL_POLYGON);//awal polygon
    glColor3f(1.0,1.0,1.0);//pemberian warna polygon kotak keranjang (warna putih)
    glVertex2f(0 + x_pos, 4);
    glVertex2f(2 + x_pos, 6);
    glVertex2f(6 + x_pos, 6);
    glVertex2f(4 + x_pos, 4);
    glEnd();//akhir
    ...
    glVertex2f(2 + x_pos, 1);
    glVertex2f(1 + x_pos, 2);
